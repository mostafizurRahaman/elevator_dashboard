...
const AboutUsPage = () => {
  ...
  const handleSave = async () => {
    ...
    console.log("Saving About Us Content:", currentContent)
  }
      ...
      <Card className="border-chart bg-gradient-primary rounded-xl border-2 p-0.5! py-0.5!">
        <CardContent className="rounded-xl bg-secondary p-8 md:p-12">
          <div className="mb-10 flex flex-col items-center justify-center text-center">
            ...
            >
              Share your story. Edit the content that describes your platform&apos;s
              mission, vision, and the team behind the scenes.
            </Typography>
          </div>
          ...
          <div className="rounded-xl bg-background p-6 shadow-2xl">
            <div className="flex flex-col gap-4">
              ...
              <div className="mt-6 flex justify-center">
                ...
                >
                  {isUpdating ? "Saving..." : "Save About Us"}
                </Button>
              </div>
            </div>
          </div>
